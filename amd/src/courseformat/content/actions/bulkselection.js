 ...
 * This overrides course/format/amd/src/local/content/actions/bulkselection.js
 * To use our CSS selectors instead, allowing Single section scope.
 *
 * @module     theme_snap/courseformat/content/actions/bulkselection
 * @class      theme_snap/courseformat/content/actions/bulkselection
...
class BulkSelector {
    ...
    constructor(courseEditor) {
        ...
        if (isTopics || isWeeks) {
            ...
            this.selectors.CONTENT = '#region-main .section.state-visible';
        }
    }
